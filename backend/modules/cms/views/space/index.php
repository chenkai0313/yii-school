...
$this->title = Yii::t('app','Space');

?>

<div class="fron-news-index">

     <?= Html::a(Yii::t('app', 'Create Space'),['create'],['class' => 'fa fa-plus-circle btn btn-success'])  ?>
          ...
          'columns' => [
              ...
              [
                  ...
                  'filter' => Html::activeDropDownList($searchModel,
                      'cid',
                      ArrayHelper::map(\backend\modules\cms\models\FronCategory::findOne(Space::$cid)->children(1)->all(), 'id', 'name'),
