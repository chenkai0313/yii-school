    ...
    <div class="col-xs-12 col-md-9 panel panel-default">
        <div class="panel-body">
            ...
            <?= $form->field($model, 'cid')->widget('\getpu\tree\TreeViewInput', [
                'name' => 'CompetitionResult[cid]',
                'value' => true,
                'query' => CompetitionResult::getChildrenCategory(),
    ...
    <div class="col-xs-12 col-md-3 panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group files-insert">
                ...
                <button type="button" class="btn btn-default" onclick="selectFilesDialog({ele:this,num:1,type:1,name:'CompetitionResult[fid]'})">
