    ...
    <div class="fron-entrepreneurial-form">
        ...
        <div class="col-xs-12 col-md-9 panel panel-default">
            <div class="panel-body">
                ...
                <?= $form->field($model, 'desc')->textarea(['maxlength' => true, 'rows' => 3,'style' => 'resize:vertical']) ?>

                <?= $form->field($exten, 'culture')->textarea(['rows' => 8,'style' => 'resize:vertical']) ?>

                <?= $form->field($exten, 'departments')->textarea(['rows' => 8,'style' => 'resize:vertical']) ?>

                <?= $form->field($exten, 'activity')->textarea(['rows' => 8,'style' => 'resize:vertical']) ?>
        ...
        <div class="col-xs-12 col-md-3 panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group files-insert">
                    ...
                    <button type="button" class="btn btn-default" onclick="selectFilesDialog({ele:this,num:1,type:1,name:'Organize[fid]'})">
                ...
                <?= $form->field($join, 'act_adds')->textInput() ?>
