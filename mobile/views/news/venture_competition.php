...
<head>
    ...
    <script src="<?=APP_WEB;?>js/jquery.cookie.min.js"></script>
            ...
            <div class="competition-menu" id="container">
                ...
                foreach ($VentureAll as $value) {
                    if(isset($value['fronCompetitions']['end_time'])){
                        if(time() > $value['fronCompetitions']['end_time']){
                            $dateDay = 0;
                        }else{
                            $times =  $value['fronCompetitions']['end_time'] - time();
                ...
                ?>
                    <div class="competition-detail">
                        <a href="<?php echo \yii\helpers\Url::toRoute(['news/detail','id'=>$value["id"],]);?>">
                            ...
                            <div class="time fl">报名时间：<?=date('Y/m/d',$value['fronCompetitions']['str_time']);?> ~ <?=date('Y/m/d',$value['fronCompetitions']['end_time']);?></div>
...
<div id="navigation" align="center">
    <?php
    $cupg = $_GET['cupg'] + 1;
    echo '<a href="'.\yii\helpers\Url::toRoute(['news/venture_competition','cupg'=>$cupg]).'"></a>'
    ?>
