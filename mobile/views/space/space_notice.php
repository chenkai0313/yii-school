    ...
    <div class="center">
        ...
        <div class="news-list clearfix">
            <ul class="news-bar clearfix">
                <li><a href="<?php echo \yii\helpers\Url::toRoute(['space/space_index']);?>">基本介绍</a></li>
                <li><a href="<?php echo \yii\helpers\Url::toRoute(['space/space_notice']);?>" class="active">最新公告</a></li>
                <li><a href="<?php echo \yii\helpers\Url::toRoute(['space/space_down']);?>" >文件下载</a></li>
            </ul>
            <div>
                <div class="news-menu">
