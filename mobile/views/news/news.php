...
<head>
    ...
    <style>
        ...
        .news_con .info-title {color:#4a90e2;font-size:14px;width:60%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
...
<!--==================导航==================-->
<div class="news" style="padding-bottom:119px;">
    <div class="center">
        <div class="banner">
...
<div id="navigation" align="center">
    <?php
    $cupg = $_GET['cupg'] + 1;
    echo '<a href="'.\yii\helpers\Url::toRoute(['news/index','cupg'=>$cupg]).'"></a>'
    ?>
    <!--
...
<script>
    $(".info-content p").css({"max-height":"34px","overflow":"hidden"})
</script>
</body>
</html>
<script type="text/javascript">
