...
<div class="fron-news-index">
     ...
     <?= Html::a(Yii::t('app', 'Create Notice'),['create'],['class' => 'fa fa-plus-circle btn btn-success'])  ?>
          ...
          'columns' => [
              ...
              [
                  ...
                  'filter' => Html::activeDropDownList($searchModel,
                      'cid',
                      ArrayHelper::map(\backend\modules\cms\models\FronCategory::findOne(SpaceNotice::$cid)->children(2)->all(), 'id', 'name'),
